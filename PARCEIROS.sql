...
where
   ...
   par.par_dt_vencimento BETWEEN  '01/01/2019' AND  '31/12/2023' and
   ...
   (cto.emp_nome like 'ATLANTICO SUL%' or cto.emp_nome like 'RECANTO ÁGUAS CLARAS %' or cto.emp_nome like 'VILLAGE DO SOL%') AND
