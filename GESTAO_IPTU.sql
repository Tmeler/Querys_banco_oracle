 SELECT 
  ...
  EMP.FIL_IN_CODIGO,
  EMP.PRO_IN_REDUZIDO AS COD_PROJETO,
  ETP_CODIGO,
  ETP_ST_CODIGO,
  ETP_NOME,
  BLO_CODIGO,
  ...
  UND_BO_AREATERRACO,
  UND_BO_AREAOUTROS,
  IPT.EST_INSC_IMOB_IPTU,
IPT.EST_EMP_DETENT,
IPT.EST_EMP_CNPJ,
IPT.EST_NOM_INTERNA,
IPT.EST_SITUACAO,
IPT.EST_PAVIMENTACAO,
IPT.EST_MEIOFIO,
IPT.EST_CALCADA,
IPT.EST_LIMITE_FRONT,
IPT.EST_ZN_ALIQ,
IPT.EST_VALORM2,
IPT.EST_TESTADA,
IPT.EST_TESTADAPRINC,
IPT.EST_ALVENARIA,
IPT.EST_METALICA,
IPT.EST_MADEIRA,
IPT.EST_VALORV_TER,
IPT.EST_VALORV_CONST,
IPT.EST_VALORV_IMOVEL,
IPT.EST_ALIQUOTA_IPTU,
IPT.EST_IPTU_VALORDESC,
IPT.EST_COSIP,
IPT.EST_REST_COMP,
IPT.EST_REVISAO,
IPT.EST_MECENATO_VALOR,
IPT.EST_MECENATO_PROJ,
IPT.EST_VCTO_PARC_UNIC,
IPT.EST_IMPOSTO_IPTU,
IPT.EST_IMPOSTO_ULTIMOEX,
IPT.EST_REAJUSTE_IPTU,
IPT.EST_TOTAL_IPTU,
IPT.EST_OBS_IPTU,
IPT.EST_PARCEIROPAGA 

FROM
  CONSTRUCAO.DBM_ESTRUTURA@HACASA EMP,
  CONSTRUCAO.DBM_ESTRUTURACMPESP@HACASA IPT,
  (
    SELECT
