 select
    to_char(t."EMP") as "empreendimento",
    to_char(t."CONTRATO") as "contrato",
    to_char(t."NOME") as "cliente",
    to_char(t."QUADRA") as "quadra",
    to_char(t."LOTE") as "lote",
    to_char(t."PARCELA") as "parcela",
    to_char(t."DATA VENC.") as "data_vencimento",
    to_char(t."DATA BAIXA") as "data_baixa",
...
(
    select
            ...
            cto.agn_st_nome as "NOME",
            replace(cto.BLO_ST_CODIGO, 'QD ', '') as "QUADRA",
            cto.und_st_codigo as "LOTE",
           par.par_in_codigo as "PARCELA",
           par.par_dt_vencimento as "DATA VENC.",
           par.par_dt_baixa as "DATA BAIXA",
           par.par_re_valororiginal as "VALOR ORIGINAL",
           (par.par_re_valorcorrecao) + (par.par_re_valorcorrecaobx) as "VALOR CORRIGIR",
    ...
    where
       ...
       par.par_dt_baixa is not null and
       par.par_dt_baixa >= '01/01/2021' and
